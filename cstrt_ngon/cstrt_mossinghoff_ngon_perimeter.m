% 'cstrt_mossinghoff_ngon_perimeter' provides the vertices coordinates
% (a,b) of the Mossinghoff n-gon for the maximal perimeter problem
% Please, cite...
%   M. J. Mossinghoff. Isodiametric problems for polygons. Discrete &
%   Computational Geometry, 36(2): 363-379, 2006.
function [a,b] = cstrt_mossinghoff_ngon_perimeter(n)
